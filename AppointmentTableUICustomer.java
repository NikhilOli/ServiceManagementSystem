...
public class AppointmentTableUICustomer {

    public static VBox createAppointmentTable(int userId) {
        ...
        appointmentTable.setItems(FXCollections.observableArrayList(getAppointmentData(userId)));
    ...
    public static ObservableList<Appointment> getAppointmentData(int userId) {
        ...
        try {
            ...
            String query = "SELECT appointment_id, customer_id, staff_name, service_name, appointment_date, appointment_time, staff_id, appointment_status FROM Appointments WHERE customer_id = ?";
